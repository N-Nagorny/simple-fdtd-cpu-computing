...
public:
     ...
     */
    static Dimensionless<T> PI() { return T(3.141592653589793); }
     ...
     */
    static Permeability<T> MU_0() { return PI() * Dimensionless<T>(4E-7) * (boost::units::si::henry / boost::units::si::meter); }
